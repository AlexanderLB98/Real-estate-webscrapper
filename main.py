...
def scrape_city(city = 'barcelona'):
    browser = uc.Chrome()

    url2= f'https://www.idealista.com/venta-viviendas/{city}-{city}/'
    browser.get(url2)
    ...
    while True:     
        url = f'https://www.idealista.com/venta-viviendas/{city}-{city}/pagina-{x}.htm'
